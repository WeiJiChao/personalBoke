package com.jwBlog.monitor.log;
...
public class LoggerQueue {
     ...
     * @return
     */
    public boolean push(LogMessageEntity log) {
     ...
     * @return
     */
    public LogMessageEntity poll() {
        LogMessageEntity result = null;
        try {
            result = (LogMessageEntity) this.blockingQueue.take();
