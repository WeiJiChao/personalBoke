...
public class DataCheck {
   ...
   //验证邮箱
    public static boolean isEmail(String email){     
    	String str="^([-_A-Za-z0-9\\.]+)@([-_A-Za-z0-9]+\\.)+[A-Za-z0-9]{2,3}$";
    	//String str="^([a-zA-Z0-9]*[-_]?[a-zA-Z0-9]+)*@([a-zA-Z0-9]*[-_]?[a-zA-Z0-9]+)+[\\.][A-Za-z]{2,3}([\\.][A-Za-z]{2})?$";
        Pattern p = Pattern.compile(str);     
        Matcher m = p.matcher(email); 
        return m.matches();     
    }
    public static boolean isHaveSpecialChar(String value){
        String str="^.*[<>\"\'%#;=^|(*)&+]+.*$";
        Pattern p = Pattern.compile(str);
        Matcher m = p.matcher(value);
        return m.matches();
    }
    public static boolean isHaveSpecialChar_expression(String value){
        //因同程-质检编号中存在^，故符号^不作为特殊符号。   2017-11-02
        // String str="^.*[<>\'%#=^|&+]+.*$";
        String str="^.*[<>\'%#=|&+]+.*$";
        Pattern p = Pattern.compile(str);
        Matcher m = p.matcher(value);
    ...
    public static boolean isHaveSpecialChar_expression2(String value){
        //因同程-质检编号中存在^，故符号^不作为特殊符号。   2017-11-02
        // String str="^.*[<>\'%#=^|&+]+.*$";
        String str="^.*[<>\'%=|+]+.*$";
        Pattern p = Pattern.compile(str);
