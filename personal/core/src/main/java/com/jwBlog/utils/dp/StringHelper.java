...
import com.jwBlog.utils.DataCheck.DataCheck;
...
//            Pattern p = Pattern.compile("\\s*|\t|\r|\n");
	...
	public static String addStringToArrayInString(String strToAdd,
		...
		String[] addedArray = addStringToArray(strToAdd, arrayInStr
				.split(split));
		return StringHelper.getStringFromStringArray(addedArray, split);
	}
	...
	public static String removeStringFromArrayInString(String strToRemove,
		...
		String[] removededArray = removeStringFromArray(strToRemove, arrayInStr
				.split(split));
		return StringHelper.getStringFromStringArray(removededArray, split);
	}
	 ...
	 * @return
	 */
	public static Integer[] getIntArrayFromArrayInString(String strArray,
			String spliter) {
		if (isEmpty(strArray)) {
		...
		Integer[] result = new Integer[intArray.size()];
		int i = 0;
	...
	public static List<String> toList(String text, String seperator) {
		...
		if(StringHelper.isNull(seperator)) {
			res.add(text);
			return res;
		}
	...
	public static List<Integer> toIntList(String text, String seperator) {
		...
		if(StringHelper.isNull(seperator)) {
			if(!DataCheck.isDecimal(text)) {
				res.add(Integer.parseInt(text));
			}
			return res;
		}
		for(String str : text.split(seperator)) {
			if(StringHelper.isNull(str)&&!DataCheck.isDecimal(str)) {
				continue;
			}
	...
	public static String getFunction4Set(String field) {
		...
		if(StringHelper.isNull(field)) {
			return field;
		}
		return FUNCTION_TITLE_SET + StringHelper.toUpper4FirstChar(field);
	}
	...
	public static String getFunction4Get(String field) {
		...
		return FUNCTION_TITLE_GET + StringHelper.toUpper4FirstChar(field);
	}
}
