...
public final class JsonUtil {
	...
	static {
		mapping.put(Date.class, new SimpleDateFormatSerializer(Constants.param_default_dateTimeFormat));
		mapping.put(Timestamp.class, new SimpleDateFormatSerializer(Constants.param_default_dateTimeFormat));//数据库的一个时间类型
	}
	/**
	 * 将对象转换成JSON字符串 --固定时间格式"yyyy-MM-dd HH:mm:ss"
	 * @param bean BO/VO,map,数组,list 对象
	 * @return JSON字符串
